    ...
    <main className="h-screen pt-12">
      ...
      <section className="w-3/4 m-auto flex flex-col items-center space-y-8 mt-10">
        ...
        <div className="flex flex-col space-y-8">
          <div className="text-base md:text-2xl dark:text-zinc-100 text-justify">
          ...
          <div className="text-base md:text-2xl dark:text-zinc-100 text-justify">
            In my free time <IoMdTime className="text-yellow-400 inline" />, I code website for my <a href="https://www.youtube.com/@codebytheo" target="_blank" className={`${badgeVariants({ variant: "default"})} dark:bg-zinc-800 flex items-center text-red-600 font-semibold p-1`}><RiYoutubeLine size={22} className="inline mr-1" /> channel
            ...
            <RiInstagramLine size={22} className="inline mr-1" /> <span className="text-[12px] md:text-sm">1st</span>gram</a> and <a href="https://www.instagram.com/theoyothtyping/" target="_blank" className={`${badgeVariants({variant:'default'})} dark:text-pink-600 dark:bg-zinc-800 font-semibold text-xl p-1`}><RiInstagramLine size={22} className="inline mr-1" /> <span className="text-[12px] md:text-sm">2nd</span>gram</a>. graphic design is my another thing that i love to do🚀.
          </div>
        </div>
      </section>
    </LayoutAnimation>
